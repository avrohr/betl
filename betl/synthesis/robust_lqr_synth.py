...
from betl.synthesis.syntheziser import LQRSyntheziser, NoControllerFound
...
class RLQRSyntheziser(LQRSyntheziser):
    ...
    def solve_lqr_lmi_hinf(self, alpha=1., conf=.95):
        ...
        F.add_constraint(expr0 >> self.picos_eps * np.eye(expr0.shape[0]))
        ...
        F.add_constraint(expr4 >> self.picos_eps * np.eye(expr4.shape[0]))

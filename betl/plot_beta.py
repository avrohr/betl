...
plt.plot(n_beta[1:], GN[1:], label='mean', linewidth=1, color='black')
...
plt.legend(loc="lower right",
           borderaxespad=0.2, ncol=1, edgecolor='white', facecolor='white',
           framealpha=1, frameon=True, labelspacing=0.2, )
